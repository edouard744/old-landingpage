...
<img src="{{ asset('storage/about.png') }}" alt="Une image de moi" class="w-full block mb-10 lg:col-start-1 lg:row-start-1 lg:row-span-2 lg:place-self-center mx-auto lg:mx-0 max-w-lg lg:mb-0 xl:place-self-end xl:my-auto">
<div class="md:mt-10 sm:mx-auto lg:mx-0 max-w-xl block sm:text-lg">
<p class="mb-6 hyphens-auto">J’ai 22 ans et je suis un passionné de développement web qui viens tout juste de terminer son bachelier.</p>
