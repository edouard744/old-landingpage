...
<nav class="w-full z-20 bg-white sm:border-b-2 sm:border-grey-400 relative h-full min-w-max ">
    <div class="nav-container sm:max-w-3xl mx-auto flex justify-between items-center relative'">
        ...
        <ul class="menu-items sm:relative flex flex-col sm:flex-row gap-16 justify-center sm:justify-end bg-blue-800 sm:bg-transparent  sm:text-blue-600 z-20  items-center pt-28 sm:py-6 h-screen sm:h-max w-full  absolute top-0 left-0 text-center text-2xl sm:text-lg">
            <li class="list-none"><a href="/home" class="hover:underline focus:underline sm:hover:text-blue-600 sm:focus:text-blue-600  focus:scale-105 duration-200 hover:scale-105 block {{str_contains( $currentUrl, '/home') ? ' sm:text-blue-600 text-white underline sm:no-underline font-semibold' : 'font-medium sm:text-grey-800 text-white ' }}">Accueil</a></li>
