<footer class="bg-footer js-footer-box overflow-hidden px-4 py-24 text-white md:px-8" {{ $attributes }}>
    ...
    <div class="mb:items-center mx-auto mb-10 flex max-w-7xl flex-col px-10 md:flex-row md:justify-between lg:px-0">
        <div class="js-footer-left mb-10 flex flex-col justify-center gap-6 md:justify-start">
            ...
            <a class="js-footer-left hover:underline" href="#">{{ __('buttons.navigation.home') }}</a>
            <a class="js-footer-left hover:underline" href="#">{{ __('buttons.navigation.projects') }}</a>
            <a class="js-footer-left hover:underline" href="#">{{ __('buttons.navigation.contact') }}</a>
        </div>
    ...
    >
        ...
        <a class="js-footer-down hover:underline" href="#">{{ __('message.footer.conditions') }}</a>
    </div>
</footer>
