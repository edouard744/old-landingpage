...
<html lang="en">
    ...
    <x-body>
        <x-main-nav />
        <section
            class="bg-hero relative flex h-screen flex-col items-center gap-8 bg-cover py-32 xl:flex-row xl:justify-center"
        >
            <div class="flex flex-col gap-4">
                <h1 class="max-w-sm text-5xl font-bold text-blue-900">
                    <span class="mb-2 block text-sm text-blue-500">Contact</span>
                    Parlez moi de
                    <span class="text-blue-500">votre projet !</span>
                </h1>
                <p class="max-w-md text-xl font-medium text-blue-700">
                    Vous pouvez m'expliquer votre demande via ce formulaire ou en me contactant via mes coordonnées si
                    dessous.
                </p>
                <div>
                    <div class="flex gap-5 text-blue-800">
                        <svg
                            class="h-6 w-6 fill-blue-800"
                    ...
                    <div class="flex gap-5 text-blue-800">
                        ...
                        <span>Tel : +32 498 043 730</span>
                    </div>
                </div>
            </div>
            <div class="w-full max-w-xl rounded-lg border-2 border-grey-200 bg-white p-10 shadow-lg xl:w-1/2">
                        ...
                        >
                            <div class="flex">
                                <div class="py-1">
                                    ...
                                    >
                                        <path
                                            d="M2.93 17.07A10 10 0 1 1 17.07 2.93 10 10 0 0 1 2.93 1 7.07zm12.73-1.41A8 8 0 1 0 4.34 4.34a8 8 0 0 0 11.32 11.32zM9 11V9h2v6H9v-4zm0-6h2v2H9V5z"
                                        />
                                    </svg>
                                </div>
