        ...
        <section class="bg-contact relative flex min-h-screen py-3">
            <div class="mx-auto flex w-full max-w-7xl flex-col items-center justify-center">
                ...
                >
                    ...
                    />
                    <x-formcontact
                        class="col-span-4 row-start-1 w-full rounded-t-3xl border-x-2 border-b-2 border-gray-200 bg-white p-10 xl:rounded-r-3xl xl:rounded-tl-none xl:border-y-2 xl:border-r-2"
                    />
                </div>
            </div>
        </section>
